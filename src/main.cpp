...
#if defined(NDEBUG)
# error "AstroCoin cannot be compiled without assertions."
#endif
...
static const int64_t nTargetTimespan = 1.0 * 24 * 60 * 60; // Astrocoin: 1.0 days
static const int64_t nTargetSpacing = 3.0 * 60; // Astrocoin: 3.0 minutes
...
{
        static const int64_t        BlocksTargetSpacing                        = 3 * 60; // 180 seconds
        unsigned int                TimeDaySeconds                                = 60 * 60 * 24;
        int64_t                       PastSecondsMin                                = TimeDaySeconds * 0.38;
        int64_t                       PastSecondsMax                                = TimeDaySeconds * 1.13;
...
void ThreadScriptCheck() {
    RenameThread("astrocoin-scriptch");
