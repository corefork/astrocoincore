...
void Shutdown()
{
    ...
    RenameThread("astrocoin-shutoff");
    ...
    if (pwalletMain)
        bitdb.Flush(false);
    GenerateAstroCoins(false, NULL, 0);
#endif
    StopNode();
...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: astrocoin.conf)") + "\n";
    strUsage += "  -datadir=<dir>         " + _("Specify data directory") + "\n";
    strUsage += "  -testnet               " + _("Use the test network") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: astrocoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 14333 or testnet: 19444)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 14332 or testnet: 19443)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the AstroCoin Wiki for SSL setup instructions)") + "\n";
...
{
    RenameThread("astrocoin-loadblk");
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. AstroCoin is probably already running."), strDataDir));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("AstroCoin version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    if (pwalletMain)
        GenerateAstroCoins(GetBoolArg("-gen", false), pwalletMain, GetArg("-genproclimit", -1));
#endif
