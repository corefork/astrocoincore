...
#ifndef H_ASTROCOIN_SCRIPT
#define H_ASTROCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CAstroCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, AstroCoin always counted CHECKMULTISIGs
