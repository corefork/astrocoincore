...
B4ARGS="-datadir=$D4"
$ASTROCOIND $ASTROCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$ASTROCOIND $ASTROCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $ASTROCOIND $ASTROCOINDARGS $B1ARGS &
  B1PID=$!
  $ASTROCOIND $ASTROCOINDARGS $B2ARGS &
  B2PID=$!
  $ASTROCOIND $ASTROCOINDARGS $B3ARGS &
  B3PID=$!
}
